    ...
    `;return q`
      <div class="root" style="${Y}">
        <div class="panel" style="width:${"100%"}; margin:0 auto;">
          ${!R&&N?q`${te}${ie}${U&&!K?q`<div class="divider"></div>`:q``}`:q``}
          ...
          ${R&&N?q`${U&&!K?q`<div class="divider"></div>`:q``}${te}${ie}`:q``}
        </div>
